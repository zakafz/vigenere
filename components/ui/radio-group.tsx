  ...
  return (
    ...
    >
      <RadioPrimitive.Indicator
        ...
        className="absolute -inset-px flex size-4 items-center justify-center rounded-none before:size-1.5 before:rounded-none before:bg-primary-foreground data-checked:bg-primary data-unchecked:hidden"
      />
    </RadioPrimitive.Root>
  );
}
